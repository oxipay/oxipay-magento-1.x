...
class Oxipay_Oxipayments_PaymentController extends Mage_Core_Controller_Front_Action
{
    ...
    private function getPayload($order) {
        ...
        $data = array(
            ...
            'x_url_cancel'                 => str_replace(PHP_EOL, ' ', $canceledURL),
            ...
            'x_customer_billing_address1'  => isset($billingAddressParts[0])? $billingAddressParts[0]: null,
            'x_customer_billing_address2'  => isset($billingAddressParts[1])? $billingAddressParts[1]: null,
            ...
            'x_customer_shipping_address1' => isset($shippingAddressParts[0])? $shippingAddressParts[0]: null,
            'x_customer_shipping_address2' => isset($shippingAddressParts[1])? $shippingAddressParts[1]: null,
